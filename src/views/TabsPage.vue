<template>
    <ion-page>
      <ion-tabs>
        ...
        <ion-tab-bar>       
          ...
          <ion-tab-button tab="Panoramica" href='/panoramica'>
              <ion-icon :icon="imagesOutline" />
          <ion-label>Panoramic</ion-label>
          </ion-tab-button>
  ...
  import { homeOutline,imagesOutline, cameraOutline, videocamOutline} from 'ionicons/icons';
